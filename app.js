...
function visualQualityLabel(product){if(!product?.visual?.src)return 'Foto pendiente';return product?.visualSource==='premium-override'?'Restauración HD':product?.visual?.kind==='restored'?'Foto restaurada':'Referencia aproximada';}
