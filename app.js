...
const CODEBREW_PHOTO_WHATSAPP='https://wa.me/525521104575';
...
const photoRequest=hasPhoto?'':`<aside class="catalog-photo-request"><a href="${missingPhotoWhatsappUrl(item)}" target="_blank" rel="noopener noreferrer" aria-label="Abrir WhatsApp para enviar una foto legible de ${escapeHtml(articleName(item))}, Código Día ${escapeHtml(item.codigoDia||product.codigoDia||'no identificado')}"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9 4l1.2-1.5h3.6L15 4h3a3 3 0 013 3v10a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h3zm3 3a5 5 0 100 10 5 5 0 000-10zm0 2.2a2.8 2.8 0 110 5.6 2.8 2.8 0 010-5.6z"/></svg><span><b>Enviar foto por WhatsApp</b><small>Archivo sugerido · ${escapeHtml(uploadName)}</small></span></a></aside>`;
