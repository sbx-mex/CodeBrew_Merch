...
const matches=catalogPool.filter(row=>matchesCatalogCategory(row.item.visualProduct,catalogCategory)&&(catalogPhotoState==='all'||(catalogPhotoState==='with-photo')===Boolean(row.item.visualProduct.visual?.src)));
